...
export class Service {
  ...
  async createPost({ title, content, slug, featuredImage, status, userId }) {
    try {
      return await this.databases.createDocument(
        ...
        // you are giving the document an id as slug
        slug,
        {
          title,
          content,
      ...
      console.log("Appwrite services :: config :: createPost :: error", error);
    }
  }
  ...
  async getAllPosts(queries = [Query.equal("status", "active")]) {
    try {
      ...
      console.log("Appwrite services :: config :: getAllPosts :: error", error);
      return false;
    }
  }
